...
<div class="panel panel-default">
	...
	<div class="col-md-4">
		<div class="form-group">
			...
			<option></option>
				<?php
				$fquery=mysqli_query($conn,"SELECT *,concat(lastname,' ',firstname,' ',midname) as name from employee natural join position where position.position LIKE 'Manager%' and (employee.eid NOT IN (SELECT  project_team.eid from project_team ) or eid not in (SELECT team_member.eid from team_member)) ");
				...
				// $fquery=mysqli_query($conn,"SELECT *,concat(lastname,' ',firstname,' ',midname) as name from employee where employee.eid NOT IN (SELECT  project_team.eid from project_team ) or eid not in (SELECT team_member.eid from team_member) ");
